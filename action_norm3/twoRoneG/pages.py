...
class SpecialRound(Page):
    form_model = 'player'
    form_fields = ['sp_pressed_red', 'sp_pressed_green', 'sp_unaff_1r', 'sp_unaff_2r1g', 'sp_unaff_2r0g',
                   'sp_aff_1r', 'sp_aff_2r1g', 'sp_aff_2r0g']
...
class Stage2Decision(Page):
    ...
    def vars_for_template(self):
        return {
            'red_presser1': self.group.get_player_by_role('red_presser1').p_id,
            'red_presser2': self.group.get_player_by_role('red_presser2').p_id
        }
...
class Stage3Decision(Page):
    ...
    def error_message(self, values):
        if (self.group.get_player_by_role('green_presser').pressed_green or self.group.num_red_pressed != 2) and values['green_d_pts'] != 0:
            return "0 points must be assigned to green button non-presser as green button was pressed"
