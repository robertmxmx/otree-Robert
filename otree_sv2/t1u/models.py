...
class Player(BasePlayer):
    ...
    c1a = models.IntegerField()
    c1b = models.IntegerField()
    c1a_wrong = models.IntegerField(initial=0)            # Counts how many times Comprehension Questions were
    c1b_wrong = models.IntegerField(initial=0)            # answered incorrectly
    # Comprehension Questions 2
    c2a = models.IntegerField()
    c2b = models.IntegerField()
    c2a_wrong = models.IntegerField(initial=0)
    c2b_wrong = models.IntegerField(initial=0)
